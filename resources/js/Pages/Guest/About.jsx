...
import fileTransferPhoto from '@//../images/3012865.jpg';
            ...
            <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                    <div className="w-full lg:w-6/12">
                        <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
                            At EZEPost, we're revolutionizing the way you handle file transfers.</h2>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">Our mission is to
                            revolutionize the way people share and transfer files, making it seamless, secure, and
                            efficient. We strive to create a platform that caters to the needs of individuals and
                            businesses alike, ensuring that everyone can send and receive files with ease and
                            confidence.</p>
                    </div>
                    <div className="w-full lg:w-6/12">
                        <img className="lg:block hidden w-full" src={fileTransferPhoto}
                             alt="people discussing on board"/>
                        <img className="lg:hidden sm:block hidden w-full"
                             src="https://i.ibb.co/16fPqrg/Rectangle-122-2.png" alt="people discussing on board"/>
                        <img className="sm:hidden block w-full" src="https://i.ibb.co/Jxhpxh6/Rectangle-122.png"
                             alt="people discussing on board"/>
                ...
                <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                    <div>
                        ...
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">Founded in 2023, our company
                            is dedicated to providing secure, efficient, and user-friendly file transfer solutions for
                            individuals and businesses alike.</p>
                    </div>
                    <div>
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">200K
                            Files Securely Sent</p>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">We take pride in our
                            achievement of securely transferring over 200,000 files, ensuring the integrity and
                            confidentiality of our users' data.</p>
                    </div>
                    <div className="sm:block hidden">
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">20K
                            Registered Users</p>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">Over 20 thousand happy
                            customers so far. Including businesses.</p>
                    </div>
                </div>
                ...
                <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                    <div className="w-full lg:w-6/12">
                        ...
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
                            Our mission is to revolutionize the way people share and transfer files, making it seamless,
                            secure, and efficient. We strive to create a platform that caters to the needs of
                            individuals and businesses alike, ensuring that everyone can send and receive files with
                            ease and confidence.</p>
                        <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">We
                            are committed to maintaining the highest standards of data security and privacy. Our goal is
                            to provide a service that not only meets but exceeds expectations, fostering a community of
                            users who trust and rely on us for their file transfer needs.</p>
                    </div>
                    <div className="w-full lg:w-6/12">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                            ...
                            <div className="flex p-4 shadow-md">
                                <div className="mr-6">
                                    <svg className="mr-6" width="36" height="36" viewBox="0 0 36 36" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            ...
                                            stroke="#1F2937" strokeWidth="2.75" strokeLinecap="round"
                                            strokeLinejoin="round"/>
                                        <path
                                ...
                                <div className="">
                                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Technology</p>
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">We leverage the
                                        latest advancements in technology to ensure our platform remains at the
                                        forefront of the file transfer industry.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex p-4 shadow-md">
                                ...
                                <div className="">
                                    ...
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">At the heart of
                                        our operations is a team of seasoned professionals, each bringing a unique set
                                        of skills and experiences to the table.</p>
                                </div>
                            </div>
                                ...
                                <div className="mr-6">
                                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="#1F2937" strokeWidth="2.75" strokeLinecap="round"
                                            strokeLinejoin="round"/>
                                        <path d="M4.5 10.5L18 19.5L31.5 10.5" stroke="#1F2937" strokeWidth="2.75"
                                              strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                </div>
                                <div className="">
                                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Press</p>
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">It is a long
