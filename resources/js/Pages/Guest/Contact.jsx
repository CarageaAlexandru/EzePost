                ...
                <div className="lg:flex">
                    <div
                        ...
                        <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                            <h1 className="xl:text-4xl text-3xl pb-4 text-white font-bold">Let's get in touch!</h1>
                            <p className="text-xl text-white pb-8 leading-relaxed font-normal lg:pr-4">Have a question
                                or need assistance?
                                Perhaps you have some valuable suggestions for us? We're all ears! Don't hesitate to
                                reach out. We're here to support you and are always eager to hear from you. Let's
                                connect and make great things happen together!</p>
                            <div className="flex pb-4 items-center">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         className="icon icon-tabler icon-tabler-phone-call" width={20} height={20}
                                ...
                                <p className="pl-4 text-white text-base">+44 7749 423 321</p>
                            </div>
                            <div className="flex items-center">
                                ...
                                <p className="pl-4 text-white text-base">contact@ezepost.com</p>
                            </div>
                        </div>
                    </div>
                    <div
